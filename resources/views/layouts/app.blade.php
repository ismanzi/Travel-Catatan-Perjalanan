...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark">
        <div class="container">
            <a class="navbar-brand" href="{{ route('home') }}">
                <i class="bi bi-journal-text"></i> Peduli Diri
            </a>
                    ...
                    @if (Auth::check())
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('travel.index') }}">
                                <i class="bi bi-list-ul"></i> Catatan Perjalanan
                            </a>
                        </li>
                        <li class="nav-item">
    ...
    <footer>
        <div class="container">
            <p>&copy; {{ date('Y') }} Catatan Perjalanan. Dibuat oleh <a href="https://github.com/ismanzi" target="_blank">Isman Fauzi</a>.</p>
        </div>
    </footer>
